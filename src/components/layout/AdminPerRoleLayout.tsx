            ...
            <nav className="flex flex-col md:gap-2 gap-3">
              ...
              <Link
                ...
                className={`flex items-center md:px-3 px-4 py-2 rounded-lg ${
                  isActive('/redocs/adminRole/dashboard')
              ...
              <div>
                ...
                >
                  ...
                  <span className="md:text-sm text-base flex-1 text-left">All Documents</span>
                  <ChevronRight
                  ...
                  <div className="ml-8 mt-1 flex flex-col gap-1">
                    <Link
                      ...
                      className={`flex items-center px-3 py-2 rounded-lg ${
                        isActive('/redocs/adminRole/documents')
                    ...
                    <Link
                      to="/redocs/adminRole/documents/tracking"
                      className={`flex items-center px-3 py-2 rounded-lg ${
                        isActive('/redocs/adminRole/documents/tracking')
                          ? 'bg-blue-100 text-blue-700'
                          : 'hover:bg-gray-100 text-gray-700'
                      }`}
                      onClick={closeSidebar}
